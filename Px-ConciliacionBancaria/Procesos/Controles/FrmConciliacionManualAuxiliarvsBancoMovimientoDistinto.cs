...
{
    public partial class FrmConciliacionManualAuxiliarvsBancoMovimientoDistinto : FormaGenBar
    {
        ...
        public FrmConciliacionManualAuxiliarvsBancoMovimientoDistinto()
        {
            InitializeComponent();
            Start();
        }
        ...
        {
            _Titulo = "Conciliación Manual Por Tipo de Movto. Distinto";
        ...
        private async Task LoadGrid2()
        {
            ...
            {
                Name = "FormaDePago",
                HeaderText = "FormaDePago",
                DataPropertyName = "FormaDePago"
            });
            ...
            dataTable.Columns.Add("Concepto", typeof(string));
            dataTable.Columns.Add("Tipo", typeof(string));
            dataTable.Columns.Add("FormaDePago", typeof(string));
        ...
        private void comboMes_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                rbConciliar.Enabled = true;
                rbCargos.Enabled = true;
                rbAbonos.Enabled = true;
            }
